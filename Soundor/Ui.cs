...
namespace Soundor
{
    internal static class Ui
    {
        ...
        private static string GetStr(double val)
        {
        ...
        private static string ReadEntry(string cur, int? lastLeft)
        {
            var input = cur;
        ...
        private static void DrawEmptyLine(int top, bool addNewline)
        {
        ...
        private static void DrawEmptyVal(int top)
        {
            Console.SetCursorPosition(_leftVal, top);
            Console.Write("                                               ");
        }

        private static void DrawVal(int top, object val)
        {
            DrawEmptyVal(top);
        ...
        private static void DrawObj(int left, int top, object o)
        {
        ...
        private static double GetNewValDbl(
        ...
        private static double GetNewValFreqOrNote(
            string title, double curVal, double min, double max)
        {
            Debug.Assert(min < max);
        ...
        private static ulong GetNewValUlong(
        ...
        private static string GetNewValStr(string title, string curVal)
        {
            string newVal;
            int offset;
        ...
        private static void DrawQuestion(string question)
        {
            string options = "[y/n]";
            int offset = 2;
        ...
        private static bool GetIsConfirmed(string question)
        {
            bool retVal;
